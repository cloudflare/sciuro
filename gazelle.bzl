...
def deps():
    ...
    go_repository(
        ...
        sum = "h1:qK51JcUR9l/unhawGA9F9B64OCYfcGewhPNprem/Acc=",
        version = "v0.21.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:Itb4+NjG9wRdkAWgVucbM/adyIXxEhbw0866e0uZE6A=",
        version = "v0.19.0",
    )
    go_repository(
    ...
    go_repository(
        ...
        sum = "h1:bKbnE878105Y2291CtM1YO9XIQJe/QsG2SRx6vxQmDI=",
        version = "v0.0.0-20210305164622-f622666832c1",
    )
    go_repository(
